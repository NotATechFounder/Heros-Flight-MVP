...
[CreateAssetMenu(fileName = "New RewardPack", menuName = "Rewards/GenericRewardPack")]
public class GenericRewardPackSO : RewardPackSO
{
    ...
    private void GenerateRandomRewardByChance(ChancedReward[] rewardArray, int currentNumberOfRewards)
    {
        float totalChance = 0;
