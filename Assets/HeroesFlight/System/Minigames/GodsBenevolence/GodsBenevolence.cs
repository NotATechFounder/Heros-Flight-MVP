...
using HeroesFlight.System.Minigames.GodsBenevolence;
using HeroesFlight.System.Minigames.GodsBenevolence.Ares;
using UnityEngine;
    ...
    public void ActivateGodsBenevolence(GodsBenevolenceSO godsBenevolence)
    {
        ...
        switch (godsBenevolence.BenevolenceType)
        {
            ...
            case GodBenevolenceType.Ares:
                ...
                benevolenceEffect.GetComponent<BenevolenceEffectInterface>().SetUp(damageInc, OnEnemyKilled);
                break;
            case GodBenevolenceType.Apollo:
                ...
                benevolenceEffect = ObjectPoolManager.SpawnObject(godsBenevolence.EffectPrefab, benevolenceSocket.TopSocket);
                benevolenceEffect.GetComponent<BenevolenceEffectInterface>().SetUp(damage);
                break;
            case GodBenevolenceType.Hercules:
                ...
                benevolenceEffect = ObjectPoolManager.SpawnObject(godsBenevolence.EffectPrefab, benevolenceSocket.TopSocket);
                benevolenceEffect.GetComponent<BenevolenceEffectInterface>().SetUp(dam);
